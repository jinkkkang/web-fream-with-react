...
var Zoneserver = React.createClass({
    ...
    showchanzone: function(id) {
            $.post("/cmd", {
              ...
              $('#db_base_url_outer').val(data[0].db_base_url_outer);
    ...
    render: function() {
        if (this.state.zoneloading || this.state.langloading) {
            ...
            var o = this;
            var agen =this.state.agentdata;
            var selectagent = agen.map(function(ent){
              return(
                  <option>{ent.AGENT}</option>
              );
            });
                            ...
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <form className="form-group">
                                        ...
                                        db_base_url_outer<input className="form-control" type="text" id="db_base_url_outer"/>
                            ...
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <div className="form-group">
                                        ...
                                        平台名称<select className="form-control" name="cagent" id="">{selectagent}</select>
                                        ...
                                        db_base_url_outer<input className="form-control" type="text" id="cdb_base_url_outer"/>
...
ReactDOM.render(
    <Zoneserver zonepage={$.getJSON(getData('7'))} agentpage={$.getJSON(getData('3'))} langpackage={$.getJSON(getData('6'))}/>, document.getElementById('show'));
