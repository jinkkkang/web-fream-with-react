...
router.post('/', function(req, res) {
    ...
    case 10:
        ...
        let zone_sql = 'select game_zone_id,agent,site_name,game_site,bin_dir,hot_bin_dir,game_host,game_port,web_port,actcode_port,open_server_date,db_base_url,db_base_url_outer,db_game_name,db_base_name,db_log_name from ' + game_config + ' where game_zone_id =' + zone_id;
    ...
    case 12:
        ...
        let check_port ='select game_port,web_port from '+ game_config + ' where game_host="'+ game_host +'" and game_zone_id !=' +czone_id+' and(game_port='+game_port+' or web_port="'+web_port+')';
        let chazone_sql = 'update ' + game_config + ' set game_site ="' + game_site +'",agent="'+ agent +'open_server_date="' + open_server_date + '",game_host = "' + game_host + '",game_port = "' + game_port + '",web_port = "' + web_port +'",actcode_port ="' + actcode_port +'",bin_dir="' + bin + '",hot_bin_dir="' + hotbin +'" where game_zone_id ="' + czone_id +'"';
    ...
    case 15:
        ...
        var agentt_sql = 'insert into t_game_config_constant (agent,login_key,charge_key,default_login_key,netty_version) values("' + agentd +'","'+login_key+'","'+charge_key+'","'+default_login_key+'","'+netty_version+'")';
